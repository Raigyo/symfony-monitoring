...
- In MySQL: `mysql> CREATE DATABASE monitoring`
- Seed: `php bin/console doctrine:fixtures:load`
  You will need to provide credentials (for the app) and datas in _src/DataFixtures_
- Provide your MySQL datas/credentials in _.env.local.php_
  EX:
...
return array (
  'APP_ENV' => 'dev',
  'APP_SECRET' => '125222929016dc969867c704e513020e',
  'DATABASE_URL' => 'mysql://<USER-NAME>:<PASSWORD>@127.0.0.1:3306/monitoring',
);
```
